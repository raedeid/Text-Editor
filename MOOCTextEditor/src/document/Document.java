...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		double sentacnce = getNumSentences();
		double syall = getNumSyllables();

		// then implement it in week 2
//		System.out.println(206.835 - 1.015*(getNumWords()/getNumSentences()) - 84.6*(getNumSyllables()/getNumWords()));
	    return 206.835 - 1.015*(words/sentacnce) - 84.6*(syall/words);
	}
